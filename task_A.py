...
leaderboard_results.to_csv('output_leaderboard_single.csv', encoding='utf-8', index=False)
...
leaderboard_results = pd.DataFrame({'Id': np.arange(pred_cat_leaderboard.shape[0]),
                                    'Scene_label': categories[pred_cat_leaderboard]})
leaderboard_results.to_csv('output_leaderboard_ensemble.csv', encoding='utf-8', index=False)
